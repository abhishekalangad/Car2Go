...
<?php
  ...
  $r_id =$_POST['r_id'];
    ...
    $a="UPDATE `rent` SET `r_status`='approved' WHERE r_id=$r_id";
...
<center><div class="banner-form-agileinfo" style="width: 300px; height: 300px;">
                  ...
                  <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" class="name" name="r_id" placeholder=" starting date" value="<?php echo $r_id; ?>" required="">
                    ...
                    <input type="submit" class="hvr-shutter-in-vertical" value="Approve" name="submit">    
                  </form>
                </div></center>
