...
echo $star=$_POST['rate'];
  ...
  $b="INSERT INTO `rating`( `rating`, `review`, `l_id`, `ur_id`) VALUES ('$star','$rating','$l_id','$rid')";
  

  if($con->query($b))
  {
  	echo "<script>window.location.replace('urenthis.php');</script>";
  }
}
