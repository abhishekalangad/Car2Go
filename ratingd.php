...
echo $star=$_POST['rate'];
   ...
   $b="INSERT INTO `drating`( `rating`, `review`, `i_id`, `ld_id`) VALUES ('$star','$rating','$l_id','$rid')";
  

  if($con->query($b))
  {
  	echo "<script>window.location.replace('udriverthis2.php');</script>";
  }
}
...
<section class="blog" id="blog">
 ...
 <?php
  ...
  echo $s1="SELECT *
FROM driver_reg WHERE dl_id=$rid";
   ...
   // $state=$row['d_state']
      ...
      <div class="col-md-4 blog-grid" style="margin-top:30px; ">
        ...
        <!--  <p><?php echo $company;" "?><?php echo $mname;" "?><?php echo $year;" "?></p> -->
          ...
          <form action="ratingd.php" method="POST">
  ...
  <br>
    ...
    <p> <input type="hidden" name="rid" value="<?php echo $r_id; ?>"></p>
