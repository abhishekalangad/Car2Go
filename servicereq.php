...
<section class="blog" id="blog">
 ...
 <?php
$s="SELECT * FROM user_reg INNER JOIN bservice on user_reg.ul_id=bookservice.cs_cid ";
 ...
 //  $day2=$row['b_day2'];
   ...
   // $state=$row['d_state']
     ...
     <!--     <p>Requesting user: <?php echo $req;?></p> -->
         ...
         <a href="bdongoing.php?b_id=<?php echo $d_id;?>" class="btn btn-success">ongoing</a></p>
        <p><a href="bdcompleted.php?b_id=<?php echo $d_id;?>" class="btn btn-success">completed</a></p>
