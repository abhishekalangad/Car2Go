...
$daysLeft = abs(strtotime($day1) - strtotime($day2));
  ...
  $pay=$days*$ramt;
      ...
      <div class="col-md-4 blog-grid" style="margin-top:30px; float: left;">
        ...
        <!--  <p><?php echo $company;" "?><?php echo $mname;" "?><?php echo $year;" "?></p> -->
         ...
         <p>ending date: <?php echo $day2;?></p>
		  <p>status : <?php echo $ssttt= $status;?></p>
         <p>status : <?php echo $pay;?></p
         
         
         <?php 
		  if($row['payment']=='' && $rrr!=$l_id)
		  {
...
<?php } ?>
        ...
        <?php 
		  ...
		  if($br_id == $l_id )
		  {
             ...
             {
                ?>
<p><a  class="btn btn-success">confirmed</a></p>
                <?php
             }
             else
             {
